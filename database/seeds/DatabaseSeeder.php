...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('blog')->insert([
            'id' => '1',
            'title' => 'O mnie',
            'post' => 'Przepraszamy, strona w budowie. Zapraszamy już wkrótce.',
